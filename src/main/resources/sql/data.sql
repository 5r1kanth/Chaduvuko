...
INSERT INTO Users (Username, Password, Email, Role, Name, Bio, Profile_Picture) VALUES
...
INSERT INTO Courses (Title, Description, Category, UserID, Language, Thumbnail, Progress, Creation_Date, Last_Updated_Date) VALUES
('Introduction to Programming', 'Learn the basics of programming', 'Programming', 2, 'ENGLISH', 'thumb1.jpg', 30.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Math', 'Basic Mathematics course', 'Mathematics', 4, 'ENGLISH', 'thumb2.jpg', 45.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Science Basics', 'Fundamentals of Science', 'Science', 6, 'ENGLISH', 'thumb3.jpg', 55.5, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Art History', 'Introduction to Art History', 'Art', 10, 'ENGLISH', 'thumb4.jpg', 60.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Advanced Programming', 'Deep dive into programming', 'Programming', 2, 'ENGLISH', 'thumb5.jpg', 75.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Physics Principles', 'Explore the physics', 'Science', 8, 'ENGLISH', 'thumb6.jpg', 80.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Digital Design', 'Basics of digital design', 'Design', 10, 'ENGLISH', 'thumb7.jpg', 20.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Biology Basics', 'Introduction to Biology', 'Biology', 6, 'ENGLISH', 'thumb8.jpg', 10.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Web Development', 'Build your first website', 'Programming', 2, 'ENGLISH', 'thumb9.jpg', 15.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00'),
('Data Science', 'Fundamentals of data science', 'Data Science', 10, 'ENGLISH', 'thumb10.jpg', 50.0, '2025-01-28 10:00:00', '2025-01-28 10:00:00');

select * from modules;

INSERT INTO Modules (CourseID, Title, Description, Module_Order) VALUES
...
INSERT INTO Lectures (ModuleID, Title, Downloadable_MaterialsURL, Lecture_Order) VALUES
...
(5, 'Newtons Laws', 'http://chaduvuko.com/materials/newton_laws.pdf', 1),
...
INSERT INTO Quizzes (CourseID, Title, Description, Total_Points) VALUES
...
INSERT INTO Quiz_Questions (QuizID, Question_Text, Question_Type, Options, Correct_Answer) VALUES
(1, 'Are strings data types?', 'TRUE_FALSE', JSON_ARRAY('True', 'False'), 'True'),
(1, 'What is a variable?', 'MULTIPLE_CHOICE', JSON_ARRAY('A container', 'A function', 'An operator'), 'A container'),
(2, 'What does "if" do?', 'MULTIPLE_CHOICE', JSON_ARRAY('Checks a condition', 'Loops code'), 'Checks a condition'),
(3, 'What is algebra about?', 'MULTIPLE_CHOICE', JSON_ARRAY('Shapes', 'Equations'), 'Equations'),
(4, 'What defines geometry?', 'MULTIPLE_CHOICE', JSON_ARRAY('Lines', 'Equations'), 'Lines'),
(5, 'Who defined gravity?', 'MULTIPLE_CHOICE', JSON_ARRAY('Newton', 'Einstein'), 'Newton'),
(6, 'Mona Lisa was painted by?', 'MULTIPLE_CHOICE', JSON_ARRAY('Da Vinci', 'Picasso'), 'Da Vinci'),
(7, 'OOP is about?', 'MULTIPLE_CHOICE', JSON_ARRAY('Classes', 'Functions'), 'Classes'),
(8, 'Color basics relate to?', 'MULTIPLE_CHOICE', JSON_ARRAY('Design', 'Math'), 'Design'),
(9, 'Genetics studies?', 'TRUE_FALSE', JSON_ARRAY('True', 'False'), 'True');

select * from enrollments;

INSERT INTO Enrollments (UserID, CourseID, Enrollment_Date) VALUES
...
INSERT INTO Certificates (UserID, CourseID, Issue_Date, CertificateURL) VALUES
